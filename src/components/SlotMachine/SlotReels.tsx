  ...
  return (
    <div className="flex gap-4 my-6">
      {Array.from({ length: 3 }).map((_, reelIndex) => (
        <div key={reelIndex} className="bg-gray-200 rounded-lg p-2 w-20 h-48 flex flex-col justify-center items-center overflow-hidden shadow-md border-2 border-gray-300">
